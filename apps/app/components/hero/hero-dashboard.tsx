  ...
  return (
    <div className="w-full h-full min-h-[500px] bg-transparent relative flex items-center justify-center font-sans pointer-events-none">
        ...
        <AnimatePresence>
          {step < 3 && (
            ...
            >
              ...
              <motion.button
                className="bg-pink-500 hover:bg-pink-600 text-white px-4 py-1.5 rounded-lg text-sm font-semibold flex items-center gap-2 shadow-sm border-0 transition-colors"
                animate={{
          ...
          {(step === 3 || step === 4) && (
            ...
            >
              ...
              <div className="w-14 shrink-0 border-r border-slate-100 flex flex-col items-center py-4 gap-6 bg-slate-50/80 z-20">
                <div className="w-8 h-8 bg-white border border-slate-200/80 rounded-lg flex items-center justify-center shadow-sm mb-2">
                  <FlankLogo size={20} />
                </div>
                {/* Active link */}
                <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-white shadow-sm border border-slate-200 text-pink-500 relative">
                  <div className="absolute -left-[17px] w-1 h-4 bg-pink-500 rounded-r-md" />
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-4">
                              ...
                              <motion.div
                                ...
                                className="bg-green-50/50 border border-green-100 p-3 rounded-xl"
                              >
                                <div className="text-[10px] text-green-600 font-bold uppercase tracking-wider mb-1">
                                  Flank
                                </div>
                                <div className="text-lg font-bold text-slate-800">
                                  $179
                        ...
                        {activeTab === 1 && (
                          <div className="space-y-4">
                            <div className="flex items-center gap-2 mb-2">
                              <span className="px-2 py-0.5 bg-orange-100 text-orange-700 text-[10px] font-bold tracking-wider rounded uppercase">
                                Sentiment Alert
                              </span>
                            </div>
                        ...
                        {activeTab === 2 && (
                          <div className="space-y-4">
                            <div className="flex items-center gap-2 mb-2">
                              <span className="px-2 py-0.5 bg-purple-100 text-purple-700 text-[10px] font-bold tracking-wider rounded uppercase">
                                Doc Change
                              </span>
                            </div>
                            <p className="text-sm text-slate-700 font-medium leading-relaxed">
                              Competitor silently updated their{" "}
            ...
            >
              ...
              <div className="flex-1 flex flex-col bg-white">
                ...
                <div className="flex-1 p-6 flex flex-col justify-end pb-8">
                  ...
                  >
                    <div className="w-9 h-9 bg-white border border-slate-200 rounded-md flex items-center justify-center shrink-0 shadow-sm">
                      <FlankLogo size={22} />
                    </div>
                ...
                <div className="flex-1 p-8 flex flex-col">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div className="px-2 py-0.5 rounded bg-[#2B2D31] text-xs font-medium text-slate-300 border border-[#383A40]">
                        Todo
                      </div>
                      <div className="px-2 py-0.5 rounded bg-red-500/10 text-red-400 text-xs font-medium border border-red-500/20">
                        High Priority
                      </div>
                    </div>
      ...
      >
        ...
        >
          <path
            d="M4 2.5L11 20L13.5 13.5L20 11L4 2.5Z"
            fill="#1A1A1A"
            stroke="white"
            strokeWidth="2"
