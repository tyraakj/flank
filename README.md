...
**Intelligence** — `11` Profiler · `12` Discovery · `13` Verifier · `14` Pricing · `15` Feature · `16` Positioning · `17` Strategist · `18` Critic · `19` Evidence Store · `20` Confidence Scoring · `41` Semantic Candidate Deduplication _(embeddings + pgvector)_
